...
1. `employees.csv' contains information on each employee such as their name, job title, salary, and so on. There are 10 employees in the company and each of them make at least $70,000. The dataset has 10 rows and 8 columns.
